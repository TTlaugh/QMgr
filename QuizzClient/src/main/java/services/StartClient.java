...
public class StartClient {
    ...
    // public double submit(String examID, String studentID, Ma) {
    // long timeTaken = 0;
    ...
    // if
    // (selectedQuestion.getCorrectAnswers().equals(selectedQuestion.getSelectedAnswers()))
    // score += scorePerQuestion;
    // Submission submission = new Submission(examID, studentID, (int) timeTaken,
    // score,
    ...
    // for (SelectedQuestion i : list)
    // map.put(i.getQuestionID(), i.getSelectedAnswers());
    // try {
