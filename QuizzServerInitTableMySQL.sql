...
('1', 'ST001', 'Trần Hoàng'    , 'Văn'   , '0933333330', 'van2@gmail.com' , 1),
('2', 'ST002', 'Nguyễn Lê'     , 'Lan'   , '0955555550', 'lan@gmail.com'  , 2),
('3', 'ST003', 'Bùi Hoàng'     , 'Lam'   , '0977777770', 'lam@gmail.com'  , 3),
('4', 'ST004', 'Mai Ánh'       , 'Tuyết' , '0988888880', 'tuyet@gmail.com', 4),
('5', 'ST005', 'Hoàng Trần Văn', 'Đức'   , '0999999990', 'duc@gmail.com'  , 5),
('6', 'ST006', 'Nguyễn Thị'    , 'Nhi'   , '0393333333', 'nhi@gmail.com'  , 3),
('7', 'ST007', 'Nguyễn Minh'   , 'Nhật'  , '0394444444', 'nhat@gmail.com' , 2),
('8', 'ST008', 'Nguyễn Thu'    , 'Minh'  , '0395555555', 'minh@gmail.com' , 1),
('9', 'ST009', 'Lê Như'        , 'Minh'  , '0398888888', 'minh1@gmail.com', 4),
('10','ST010', 'Lê Thị Bích'   , 'Tuyền' , '0399999999', 'tuyen@gmail.com', 5);
...
(1, 1, 'Chapter 1', 1, 'Sáng tác của Nguyễn Ái Quốc, Hồ Chí Minh không bao gồm những thể loại nào trong các thể loại sau đây:',
    ...
    {"answerID":4,"questionID":1,"content":"Thơ","isCorrect":false}]', false),
(2, 1, 'Chapter 1', 4, 'Tuyên ngôn độc lập của Hồ Chí Minh được viết theo thể loại nào sau đây:',
    ...
    {"answerID":4,"questionID":2,"content":"Thơ","isCorrect":false}]', false),
(3, 1, 'Chapter 2', 5, 'Thể loại nào trong các thể loại văn học sau đây ra đời trong giai đoạn kháng chiến chống Pháp (1946 - 1954)?',
    ...
    {"answerID":4,"questionID":3,"content":"Thơ","isCorrect":false}]', false),
(4, 1, 'Chapter 2', 3, 'Quê hương của Quang Dũng ở:',
    ...
    {"answerID":4,"questionID":4,"content":"1925","isCorrect":false}]', false),
(5, 1, 'Chapter 4', 2, 'Quang Dũng sinh năm nào?',
    ...
    {"answerID":4,"questionID":5,"content":"1948","isCorrect":false}]', false),
(6, 1, 'Chapter 3', 1, 'Đoàn quân Tây tiến được thành lập năm nào sau đây:',
    ...
    {"answerID":4,"questionID":6,"content":"Truyền cảm","isCorrect":true}]', false),
(7, 1, 'Chapter 4', 5, 'Cảm hứng chung của bài thơ Tây tiến là:',
    ...
    {"answerID":4,"questionID":7,"content":"Trào lộng","isCorrect":true}]', false),
(8, 1, 'Chapter 3', 2, 'Bút pháp tiêu biểu của bài thơ Tây Tiến là:',
    ...
    {"answerID":4,"questionID":8,"content":"Viết phê bình","isCorrect":true}]', false),
(9, 1, 'Chapter 3', 2, 'Hoạt động nghệ thuật của Nguyễn Đình Thi nổi bật nhất ở lĩnh vực nào?',
    ...
    {"answerID":4,"questionID":9,"content":"Người chiến sỹ","isCorrect":true}]', false),
(10, 1, 'Chapter 2', 4, 'Bài thơ Đất nước được in ở tập thơ nào?',
    ...
    {"answerID":4,"questionID":10,"content":"Tiểu thuyết","isCorrect":true}]', false);
