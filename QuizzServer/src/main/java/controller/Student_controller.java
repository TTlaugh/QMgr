    ...
    boolean btn_ImportStudent_StudentManagement(ActionEvent event) {
        ...
        if (file_Current != null) {
            ...
            try {
                ...
                Boolean selectFile = groupManager.importStudents(group_Current_StudentManagement,file_Current.getPath());
            ...
            ArrayList<Student> allStudentForCurrentGrp = studentManager.getAllStudentInGroup(group_Current_StudentManagement.getGroupId());
